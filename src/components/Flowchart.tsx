      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-border bg-surface/50 backdrop-blur-sm z-10 relative">
        ...
        <div className="flex items-center gap-2">
          {!session && (
            <button
              onClick={onConnect}
              className="flex items-center gap-1.5 px-3 py-1.5 bg-accent hover:bg-accent-2 text-white text-sm font-medium rounded-lg transition-colors cursor-pointer"
            >
